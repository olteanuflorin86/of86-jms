...
* The original package name 'com.olteanuflorin86.of86-jms' is invalid and this project uses 'com.olteanuflorin86.of86jms' instead.
...
* [Spring for Apache ActiveMQ Artemis](https://docs.spring.io/spring-boot/docs/2.7.12/reference/htmlsingle/#messaging.jms.artemis)
